...
- avg_sleep_hours: 8.62
- min_sleep_hours: 7.23
- avg_sleep_score: 88.29
- avg_hrv: 69.71
...
- selection_meta: {'selection_mode': 'primary_activity_of_day', 'candidate_count': 1, 'candidate_types': ['VirtualRun'], 'selected_type': 'VirtualRun', 'selected_training_load': 135.0, 'selected_moving_time_sec': 8513.0, 'selection_rule': '先选主训练类型（Run/Workout/Ride），再优先 Run，之后按训练负荷、时长、开始时间排序。', 'target_date': '2026-08-15'}
